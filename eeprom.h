...
#ifdef SECURITY
extern EEOFFS_NETWORK_SECURITY_STRUCT  EEOFFS_SECURITY;
#endif /* SECURITY */
...
/* The starting address of the segment _FD_EEPROM (to be used as a constant as (WORD)&_FD_EEPROM_S_) */
extern unsigned char _FD_EEPROM_S_;
/* The length of the segment _FD_EEPROM in bytes (to be used as a constant as (WORD)&_FD_EEPROM_L_) */
